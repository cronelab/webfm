...
fmlines.ChannelLines.prototype = {
  ...
  setupCharts: function () {
    ...
    svg
      ...
      .attr(
        'transform',
        'translate(' + lineWidth / 2 + ',' + margin.top * 19 + ')'
      )
    ...
    svg
      ...
      .text(
        'StimulusCode: ' + document.getElementById('currentStimCode').innerText
      )
    ...
    document.getElementById('chanSel').addEventListener('click', function (e) {
      $('#' + e.target.parentNode.parentNode.id + '>li.active').removeClass(
        'active'
      )
