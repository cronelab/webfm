...
fmscope.ChannelScope.prototype = {
  ...
  _resizePlot: function (width, height) {
    ...
    d3.select('.fm-scope-axis-x').attr(
      'transform',
      'translate(' + 0 + ',' + height + ')'
    )
  },
  ...
  _updatePlot: function () {
    ...
    d3.select('.fm-scope-axis-y').call(this.plotYAxis)
    ...
    d3.select('.fm-scope-line').datum(this.data).attr('d', this.plotLine)
  },
