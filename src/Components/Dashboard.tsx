          ...
          <Row>
            <Col sm={7}>
              <Tabs defaultActiveKey="fm" id="uncontrolled-tab-example">
                <Tab eventKey="fm" title="Functional Mapping" key={"fm_tab"}>
                ...
                <Tab eventKey="spes" title="SPES" key={"spes_tab"}>
                  <Card className="text-center">
                    <Card.Body>
                      ...
                      >
                        <Tab eventKey="cceps" title="CCEPS" key={"cceps_tab"}>
                          {records["ep"].map((ep) => {
                            return (
                              <Button
                                key={`${ep}_ccep_button`}
                        ...
                        <Tab eventKey="ccsr" title="CCSRs" key={"ccsr_tab"}>
                        ...
                        <Tab eventKey="matrices" title="Adjaceny Matrix" key={"matrix_tab"}>
                          <h2>3</h2>
                        </Tab>
                      </Tabs>
                    </Card.Body>
                ...
                <Tab eventKey="cs" title="Cortical Stimulation" key={"cortstim_tab"}>
                  <Card className="text-center">
                    <Card.Body>
                ...
                <Tab eventKey="reconstruction" title="Reconstruction" key={"recon_tab"}>
                  <Card className="text-center">
                    <Card.Body>
                ...
                <Tab eventKey="annotate" title="Clinical Annotation" key={"annotation_tab"}>
                  <Card className="text-center">
                    <Card.Body>
