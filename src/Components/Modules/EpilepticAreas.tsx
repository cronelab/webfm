            ...
            threeDElectrodes.traverse((child) => {
              ...
              if (child instanceof Mesh) {
                  if(activeRecord[child.name] != undefined){
                      child.scale.set(activeRecord[child.name].size+2,activeRecord[child.name].size+2,activeRecord[child.name].size+2);
                      //@ts-ignore
