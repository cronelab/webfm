...
//   document
//     .getElementsByClassName("fm-back")[0]
//     .setAttribute("href", `/#${subject}`);
...
//   var taskConfig = JSON.parse(
//     JSON.stringify(config.tasks[`${task}`] || config.tasks.default)
//   );
...
//   (<HTMLDivElement>(
//     document.getElementsByClassName("fm-transfer-icon")[0]
//   )).style.display = "";
//   document
//     .getElementsByClassName("fm-trial-label")[0]
//     .classList.add("fm-trial-label-active");
// };
...
//   );
//   (<HTMLDivElement>(
//     document.getElementsByClassName(`fm-working-icon`)[0]
//   )).style.display = "";
...
//     document.getElementsByClassName(`fm-working-icon`)[0]
//   )).style.display = "";
//   dataset.updateBaselineWindow(newWindow).then(() => {
//     updateDataDisplay();
//     setTimeout(
//       () =>
//         document
